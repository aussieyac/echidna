...
unsigned long baseTune =  7100000L;  // Base frequency to add or subtract the offset the pot points to
...
////Serial.print("knob value"); // value changes between -10 to 1013
//Serial.println(knob);
